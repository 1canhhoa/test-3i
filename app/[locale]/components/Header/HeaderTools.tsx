...
const HeaderTools = ({ languageData }) => {
    ...
    return (
        <div className="flex items-center justify-end px-4">
            ...
            <Link
                href="/signup"
                className=" py-3 px-7 text-base text-center font-bold text-dark hover:text-[green] dark:text-white md:block"
            >
                Đăng ký
            </Link>
            <Link
                href="/signin"
                className="ease-in-up  rounded-md bg-[green] py-3 px-8 text-base font-bold text-white transition duration-300 hover:bg-opacity-90 hover:shadow-signUp md:block md:px-9 lg:px-6 xl:px-9"
            >
                Đăng nhập
            </Link>
            </div>
