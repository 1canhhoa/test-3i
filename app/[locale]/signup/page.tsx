...
const SignupPage = () => {
  ...
  return (
    <>
      ...
      <div
        className=" wow fadeInUp relative z-10 mt-36 rounded-md bg-[green]/[3%] p-8 dark:bg-[green]/10 sm:p-11 lg:p-8 xl:p-11"
        data-wow-delay=".2s"
      >
        ...
        <form onSubmit={handleSubmit(onSignUp)}>
          ...
          <div className="flex justify-between">
            ...
            >
              <p className="flex" style={{ marginLeft: "300px" }}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m.75 12l3 3m0 0l3-3m-3 3v-6m-1.5-9H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
                </svg>

                <span>Tải xuống nghiệp vụ và cấu trúc công ty</span>
              </p>
            </button>
            <input
              ref={refInput}
            ...
            >
              <p className="flex" style={{ marginLeft: "300px" }}>
                ...
                <span>Tải lên nghiệp vụ và cấu trúc công ty</span>
              </p>
            </button>
          </div>
          <input
